...
import fetchLibrariesFilteredData from "./librariesFilteredData";
...
function LibrariesFilters(props) {
  ...
  const handleSubmit = async (data) => {
    const filteredData = await fetchLibrariesFilteredData(
      data,
      searchParams,
      router.replace
    );
...
export default LibrariesFilters;
