...
import fetchMagazinesFilteredData from "./magazinesFilteredData";
...
function MagazinesListFilters(props) {
  const {
    searchParams,
    setPagedata,
    router,
  ...
  const handleSubmit = async (data) => {
    const filteredData = await fetchMagazinesFilteredData(
      data,
      searchParams,
      router.replace
    );
...
export default MagazinesListFilters;
