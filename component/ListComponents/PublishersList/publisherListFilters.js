...
import fetchPublisherFilteredData from "./publisherFilteredData";

function PublisherFilters(props) {
  ...
  const handleSubmit = async (data) => {
    const filteredData = await fetchPublisherFilteredData(
      data,
      searchParams,
      router.replace
    );
  ...
  return (
    <>
      ...
      <div className="p-4 flex justify-center">
        ...
        <details className="bg-gray-300 open:bg-white duration-300">
