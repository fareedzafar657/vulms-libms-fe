  ...
  const handleSubmit = async (values) => {
    try {
      ...
      const response = await axiosAuth.post(
        "/materialtypes/create",
        trimmedValues
      );
      Swal.fire("Successful!", "materialtype created succesfully!", "success");
      router.push("/materialtype/list");
    } catch (error) {
      Swal.fire("Error creating materialtype:", error.response.data.message);
      console.error("Error creating materialtype:", error);
    }
  };
