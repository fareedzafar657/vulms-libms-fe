...
import LibrariesFilters from "../../../component/ListComponents/LibrariesList/librariesListFilters";
import Layoutt from "../../../component/lay/Layoutt";
import fetchLibrariesFilteredData from "../../../component/ListComponents/LibrariesList/librariesFilteredData";
...
export async function getServerSideProps(context) {
  ...
  try {
    const res = await axios.get(`/locations/pagedata?${params.toString()}`, {
      headers: {
          ...
          <div className="mx-auto w-full md:w-[800px] lg:w-[1000px]">
            <div className="flex justify-end  p-4 w-full ">
              <Stack direction={"row"} spacing={2}>
                <Link href="/libraries/createlibraries" underline="none">
                  <Button
                    size="small"
                    variant="contained"
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="left">
                          <Stack direction={"row"}>
                            <EditButton
                              link={`/libraries/${location.id}`}
                              router={router}
                            />

                            <DeleteButton
                              link={`/locations/delete/${location.id}`}
                            />
                          </Stack>
                        </TableCell>
                      </TableRow>
            ...
            <div className="flex  md:justify-between p-4">
              <Stack spacing={2} className=" md:mr-34">
                <FiltersControls
                  control="take"
                  setPagedata={setPagedata}
                  filteringData={fetchLibrariesFilteredData}
