...
function CreatePublisher() {
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      Swal.fire("Successful!", "publishers created succesfully!", "success");
      router.push("/Publisher/list");
    } catch (error) {
      Swal.fire("Error creating publishers:", error.response.data.message);
      console.error("Error creating publishers:", error.response.data.message);
    }
  };
